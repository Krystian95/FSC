...
<html lang="en">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="row form-group align-items-center">
                                        ...
                                        <div class="col-8">
                                            &nbsp;&nbsp;&nbsp; <b>1</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="meat_produttivita" type="text" class="span2" value="" data-slider-min="1" data-slider-max="100" data-slider-step="1" data-slider-value="[40,40]"/>&nbsp;&nbsp;&nbsp;&nbsp;<b>100</b>
                                        </div>
                                    </div>
                                    <div class="row form-group align-items-center">
                                        <label class="col-form-label col-4">
                                        ...
                                        <div class="col-8">
                                            <b>-100</b>&nbsp;&nbsp;&nbsp;&nbsp;<input id="meat_impatto_ghgs" type="text" class="span2" value="" data-slider-min="-100" data-slider-max="100" data-slider-step="1" data-slider-value="[2,2]"/>&nbsp;&nbsp;&nbsp;&nbsp;<b>100</b>
                                        </div>
                                    </div>
                                    <div class="row form-group align-items-center">
                                        <label class="col-form-label col-4">
                                        ...
                                        <div class="col-8">
                                            <b>-100</b>&nbsp;&nbsp;&nbsp;&nbsp;<input id="meat_impatto_pm" type="text" class="span2" value="" data-slider-min="-100" data-slider-max="100" data-slider-step="1" data-slider-value="[3,3]"/>&nbsp;&nbsp;&nbsp;&nbsp;<b>100</b>
                                        </div>
                                    </div>
                                    <div class="row form-group align-items-center">
                                        <label class="col-form-label col-4">
                                        ...
                                        <div class="col-8">
                                            <b>-100</b>&nbsp;&nbsp;&nbsp;&nbsp;<input id="meat_impatto_nh3" type="text" class="span2" value="" data-slider-min="-100" data-slider-max="100" data-slider-step="1" data-slider-value="[2,2]"/>&nbsp;&nbsp;&nbsp;&nbsp;<b>100</b>
                                        </div>
                                    </div>
                                    <div class="row form-group align-items-center">
                                        <label class="col-form-label col-4">
                                        ...
                                        <div class="col-8">
                                            &nbsp;&nbsp;&nbsp; <b>0</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="meat_ideal_ghgs" type="text" class="span2" value="" data-slider-min="0" data-slider-max="1000" data-slider-step="1" data-slider-value="[0,0]"/>&nbsp;&nbsp;&nbsp;&nbsp;<b>1000</b>
                                        </div>
                                    </div>
                                    <div class="row form-group align-items-center">
                                        <label class="col-form-label col-4">
                                        ...
                                        <div class="col-8">
                                            &nbsp;&nbsp;&nbsp; <b>0</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="meat_toll_infl_prod_ghgs" type="text" class="span2" value="" data-slider-min="0" data-slider-max="1000" data-slider-step="1" data-slider-value="[700,700]"/>&nbsp;&nbsp;&nbsp;&nbsp;<b>1000</b>
                                        </div>
                                    </div>
                                    <div class="row form-group align-items-center">
                                        <label class="col-form-label col-4">
                                        ...
                                        <div class="col-8">
                                            &nbsp;&nbsp;&nbsp; <b>0</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="meat_ideal_pm" type="text" class="span2" value="" data-slider-min="0" data-slider-max="1000" data-slider-step="1" data-slider-value="[0,0]"/>&nbsp;&nbsp;&nbsp;&nbsp;<b>1000</b>
                                        </div>
                                    </div>
                                    <div class="row form-group align-items-center">
                                        <label class="col-form-label col-4">
                                        ...
                                        <div class="col-8">
                                            &nbsp;&nbsp;&nbsp; <b>0</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="meat_toll_infl_prod_pm" type="text" class="span2" value="" data-slider-min="0" data-slider-max="1000" data-slider-step="1" data-slider-value="[800,800]"/>&nbsp;&nbsp;&nbsp;&nbsp;<b>1000</b>
                                        </div>
                                    </div>
                                    <div class="row form-group align-items-center">
                                        <label class="col-form-label col-4">
                                        ...
                                        <div class="col-8">
                                            &nbsp;&nbsp;&nbsp; <b>0</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="meat_ideal_nh3" type="text" class="span2" value="" data-slider-min="0" data-slider-max="1000" data-slider-step="1" data-slider-value="[0,0]"/>&nbsp;&nbsp;&nbsp;&nbsp;<b>1000</b>
                                        </div>
                                    </div>
                                    <div class="row form-group align-items-center">
                                        <label class="col-form-label col-4">
                                        ...
                                        <div class="col-8">
                                            &nbsp;&nbsp;&nbsp; <b>0</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="meat_toll_infl_prod_nh3" type="text" class="span2" value="" data-slider-min="0" data-slider-max="1000" data-slider-step="1" data-slider-value="[750,750]"/>&nbsp;&nbsp;&nbsp;&nbsp;<b>1000</b>
                                        </div>
                                    </div>
                                    <div class="row form-group align-items-center">
                                        <label class="col-form-label col-4">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="row form-group align-items-center">
                                        ...
                                        <div class="col-8">
                                            &nbsp;&nbsp;&nbsp; <b>1</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="veg_produttivita" type="text" class="span2" value="" data-slider-min="1" data-slider-max="100" data-slider-step="1" data-slider-value="[41,41]"/>&nbsp;&nbsp;&nbsp;&nbsp;<b>100</b>
                                        </div>
                                    </div>
                                    <div class="row form-group align-items-center">
                                        <label class="col-form-label col-4">
                                    ...
                                    <div class="row form-group align-items-center">
                                        ...
                                        <div class="col-8">
                                            <b>-100</b>&nbsp;&nbsp;&nbsp;&nbsp;<input id="veg_impatto_pm" type="text" class="span2" value="" data-slider-min="-100" data-slider-max="100" data-slider-step="1" data-slider-value="[1,1]"/>&nbsp;&nbsp;&nbsp;&nbsp;<b>100</b>
                                        </div>
                                    </div>
                                    <div class="row form-group align-items-center">
                                        <label class="col-form-label col-4">
                                        ...
                                        <div class="col-8">
                                            <b>-100</b>&nbsp;&nbsp;&nbsp;&nbsp;<input id="veg_impatto_nh3" type="text" class="span2" value="" data-slider-min="-100" data-slider-max="100" data-slider-step="1" data-slider-value="[-1,-1]"/>&nbsp;&nbsp;&nbsp;&nbsp;<b>100</b>
                                        </div>
                                    </div>
                                    <div class="row form-group align-items-center">
                                        <label class="col-form-label col-4">
                                        ...
                                        <div class="col-8">
                                            &nbsp;&nbsp;&nbsp; <b>0</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="veg_ideal_ghgs" type="text" class="span2" value="" data-slider-min="0" data-slider-max="1000" data-slider-step="1" data-slider-value="[0,0]"/>&nbsp;&nbsp;&nbsp;&nbsp;<b>1000</b>
                                        </div>
                                    </div>
                                    <div class="row form-group align-items-center">
                                        <label class="col-form-label col-4">
                                        ...
                                        <div class="col-8">
                                            &nbsp;&nbsp;&nbsp; <b>0</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="veg_toll_infl_prod_ghgs" type="text" class="span2" value="" data-slider-min="0" data-slider-max="1000" data-slider-step="1" data-slider-value="[600,600]"/>&nbsp;&nbsp;&nbsp;&nbsp;<b>1000</b>
                                        </div>
                                    </div>
                                    <div class="row form-group align-items-center">
                                        <label class="col-form-label col-4">
                                        ...
                                        <div class="col-8">
                                            &nbsp;&nbsp;&nbsp; <b>0</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="veg_ideal_pm" type="text" class="span2" value="" data-slider-min="0" data-slider-max="1000" data-slider-step="1" data-slider-value="[0,0]"/>&nbsp;&nbsp;&nbsp;&nbsp;<b>1000</b>
                                        </div>
                                    </div>
                                    <div class="row form-group align-items-center">
                                        <label class="col-form-label col-4">
                                        ...
                                        <div class="col-8">
                                            &nbsp;&nbsp;&nbsp; <b>0</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="veg_toll_infl_prod_pm" type="text" class="span2" value="" data-slider-min="0" data-slider-max="1000" data-slider-step="1" data-slider-value="[500,500]"/>&nbsp;&nbsp;&nbsp;&nbsp;<b>1000</b>
                                        </div>
                                    </div>
                                    <div class="row form-group align-items-center">
                                        <label class="col-form-label col-4">
                                        ...
                                        <div class="col-8">
                                            &nbsp;&nbsp;&nbsp; <b>0</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="veg_ideal_nh3" type="text" class="span2" value="" data-slider-min="0" data-slider-max="1000" data-slider-step="1" data-slider-value="[100,100]"/>&nbsp;&nbsp;&nbsp;&nbsp;<b>1000</b>
                                        </div>
                                    </div>
                                    <div class="row form-group align-items-center">
                                        <label class="col-form-label col-4">
                                        ...
                                        <div class="col-8">
                                            &nbsp;&nbsp;&nbsp; <b>0</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="veg_toll_infl_prod_nh3" type="text" class="span2" value="" data-slider-min="0" data-slider-max="1000" data-slider-step="1" data-slider-value="[500,500]"/>&nbsp;&nbsp;&nbsp;&nbsp;<b>1000</b>
                                        </div>
                                    </div>
                                    <div class="row form-group align-items-center">
                                        <label class="col-form-label col-4">
    ...
    foreach($products as $product => $parameter)
    {
        ...
        echo '<div class="col-6">';
        echo '<input type="range" class="custom-range" min="0" max="1000" step="1" name="' . $product . '_ghgs_ideale_slider" value="' . $parameter['ghgs_ideale'] . '">';
        echo '</div><div class="col-2">';
        echo '<input type="number" class="form-control textbox" min="0" max="1000" step="1" name="' . $product . '_ghgs_ideale" value="' . $parameter['ghgs_ideale'] . '">';
        echo '</div><div class="col-1">';
        ...
        echo '<div class="col-6">';
        echo '<input type="range" class="custom-range" min="0" max="1000" step="1" name="' . $product . '_tolleranza_ghgs_slider" value="' . $parameter['tolleranza_influenza_ghgs'] . '">';
        echo '</div><div class="col-2">';
        echo '<input type="number" class="form-control textbox" min="0" max="1000" step="1" name="' . $product . '_tolleranza_ghgs" value="' . $parameter['tolleranza_influenza_ghgs'] . '">';
        echo '</div><div class="col-1">';
        ...
        echo '<div class="col-6">';
        echo '<input type="range" class="custom-range" min="0" max="1000" step="1" name="' . $product . '_pm_ideale_slider" value="' . $parameter['pm_ideale'] . '">';
        echo '</div><div class="col-2">';
        echo '<input type="number" class="form-control textbox" min="0" max="1000" step="1" name="' . $product . '_pm_ideale" value="' . $parameter['pm_ideale'] . '">';
        echo '</div><div class="col-1">';
        ...
        echo '<div class="col-6">';
        echo '<input type="range" class="custom-range" min="0" max="1000" step="1" name="' . $product . '_tolleranza_pm_slider" value="' . $parameter['tolleranza_influenza_pm'] . '">';
        echo '</div><div class="col-2">';
        echo '<input type="number" class="form-control textbox" min="0" max="1000" step="1" name="' . $product . '_tolleranza_pm" value="' . $parameter['tolleranza_influenza_pm'] . '">';
        echo '</div><div class="col-1">';
        ...
        echo '<div class="col-6">';
        echo '<input type="range" class="custom-range" min="0" max="1000" step="1" name="' . $product . '_nh3_ideale_slider" value="' . $parameter['nh3_ideale'] . '">';
        echo '</div><div class="col-2">';
        echo '<input type="number" class="form-control textbox" min="0" max="1000" step="1" name="' . $product . '_nh3_ideale" value="' . $parameter['nh3_ideale'] . '">';
        echo '</div><div class="col-1">';
        ...
        echo '<div class="col-6">';
        echo '<input type="range" class="custom-range" min="0" max="1000" step="1" name="' . $product . '_tolleranza_nh3_slider" value="' . $parameter['tolleranza_influenza_nh3'] . '">';
        echo '</div><div class="col-2">';
        echo '<input type="number" class="form-control textbox" min="0" max="1000" step="1" name="' . $product . '_tolleranza_nh3" value="' . $parameter['tolleranza_influenza_nh3'] . '">';
        echo '</div><div class="col-1">';
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="row form-group align-items-center">
                                ...
                                <div class="col-5">
                                    <input type="range" class="custom-range" min="0" max="100" step="1" name="massima_crescita_salute_slider" value="2">
                                </div>
                                <div class="col-2">
                                    <input type="number" class="form-control textbox" min="0" max="100" step="1" name="massima_crescita_salute" value="2"> 
                                </div>
                                <div class="col-1">
